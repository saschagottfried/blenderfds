...
class ExportFDS(bpy.types.Operator, ExportHelper):
    ...
    def execute(self, context):
        return io.save(self, context, **self.as_keywords(ignore=("check_existing", "filter_glob")))
...
class ImportFDS(bpy.types.Operator, ImportHelper):
    ...
    def execute(self, context):
        return io.load(self, context, **self.as_keywords(ignore=("check_existing", "filter_glob")))
